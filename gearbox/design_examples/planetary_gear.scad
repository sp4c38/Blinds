...
split=false; // disasemble gearbox
//---------------------------------------------------------------
show_carrier_top=true;        // display gearbox carrier top part with sun gear
show_carrier_bottom=true;     // display gearbox carrier bottom part 
show_planets=true;            // display gearbox planets
show_ring_gear=true;          // display ring gear
show_motor_gear=true;         // display motor gear
show_motor_mount=false;        // display motor mounting base
show_distancer=true;          // display distancer
show_motor=false;               // display EsportsMJJ 775
...
SUN_GEAR_ID=5.7;            // sun gear shaft/hole diameter
...
MOTOR_MOUNT_ID=5.7;         // motor gear mount inner diameter
